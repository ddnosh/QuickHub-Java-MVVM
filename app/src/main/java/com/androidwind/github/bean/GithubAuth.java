...
public class GithubAuth implements Parcelable {
  public static final Creator<GithubAuth> CREATOR = new Creator<GithubAuth>() {
    @Override
    public GithubAuth createFromParcel(Parcel source) {
      return new GithubAuth(source);
    }
  ...
  public boolean equals(Object o) {
    ...
    GithubAuth githubAuth = (GithubAuth) o;

    return id != null ? id.equals(githubAuth.id) : githubAuth.id == null;
  }
